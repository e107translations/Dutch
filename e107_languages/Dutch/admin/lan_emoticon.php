...
define("EMOLAN_23", "Nieuw emotiticon XML pakkket gevonden:");
define("EMOLAN_24", "Nieuw emoticon php pakket gevonden");
...
define("EMOLAN_31", "Totaal [x] bestanden gevonden");
define("EMOLAN_32", "Onbekend Pakket gedetecteerd");
define("EMOLAN_33", "Niet-ondersteunde XML-bestandsindeling");
define("EMOLAN_34", "Ontbrekende bestanden voor pakket");
define("EMOLAN_35", " - verwijderd in database");
