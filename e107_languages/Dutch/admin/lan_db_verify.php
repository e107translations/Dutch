...
define("DBVLAN_7", "Opmerkingen");
define("DBVLAN_8", "Afwijking");
define("DBVLAN_9", "Huidige");
define("DBVLAN_10", "moet zijn");
define("DBVLAN_11", "Ontbrekend veld!");
define("DBVLAN_12", "Extra Veld!");
define("DBVLAN_13", "Ontbrekende tabel!");
define("DBVLAN_14", "Kies de te verifieëren tabel(-len)");
define("DBVLAN_15", "Start verificatie");
define("DBVLAN_16", "SQL verificatie");
define("DBVLAN_17", "Database (opslag medium) moet [x] zijn, maar is [y]");
...
define("DBVLAN_23", "Database Toepassingen");
