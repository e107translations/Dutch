...
define("LAN_EURL_DEFAULT", "Standaard");
...
define("LAN_EURL_SETTINGS_SEFTRTYPE_PLUS",
 "Plus+separator+with+no+case+CHANGE");
...
define("LAN_EURL_NEWS_REWRITE_LABEL", "Vriendelijke URL´s zonder ID (geen prestatie, vriendelijker)");
