...
define("LAN_CRON_64", "Een beheerder kan taken automatiseren met behulp van e107 Geplande taken.[br]
Er wordt hier niets uitgevoerd totdat uw server [b]cron.php[/b] 1 keer per minuut aanroept. Op het tabblad Instellingen ziet u hoe u dit kunt regelen en vindt u de opdracht die u kunt kopi&#235;ren.[br]

Op het tabblad Beheer kunt u taken bewerken, verwijderen en uitvoeren.[br]

Wanneer u een taak bewerkt, kunt u de minuten, uren, dagen, maand of dag van de week instellen waarop deze wordt uitgevoerd. Gebruik * voor elke periode en de eigenschap Actief om de taak in te schakelen.[br]

Opmerking: Het is raadzaam om de standaardtaken niet te verwijderen.[br]");
...
define("LAN_CRON_SETUP_INTRO", "Je server moet elke minuut [b]cron.php[/b] aanroepen om geplande taken uit te voeren. Kies een van de onderstaande opties, kopieer de weergegeven code naar de taakplanner van je server en gebruik slechts één optie. Anders worden geplande taken twee keer uitgevoerd.");
