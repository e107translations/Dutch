...
define("BNRLAN_40", "Nog geen campagnes."); 
define("BNRLAN_41", "Aantal te tonen banners"); 
define("BNRLAN_42", "dit geldt alleen als er meerdere campagnes zijn geselecteerd");
define("BNRLAN_43", "Hoe de campagnes te tonen?"); 
define("BNRLAN_44", "Weergave type.."); 
define("BNRLAN_45", "Een campagne in een enkel menu");
...
define("BNRLAN_HELP_IMPRESSIONS", "0 = Onbeperkt");
define("BNRLAN_HELP_KEYWORDS", "Wanneer nieuws of pagina's worden geladen, beperkt dit de bannerresultaten tot overeenkomende zoekwoorden. Wees hier voorzichtig mee.");
define("BNRLAN_HELP_IMPRESSIONS", "0 = Onbeperkt");
define("BNRLAN_HELP_KEYWORDS", "Wanneer nieuws of pagina's worden geladen, beperkt dit de bannerresultaten tot overeenkomende zoekwoorden. Wees hier voorzichtig mee.");
...
define("BNRLAN_TITLE_REMOTE_IMAGE", "Dit overschrijft elke lokale afbeelding die je hebt ingesteld.");
define("BNRLAN_MENU_MANAGER_CONFIG", "Het menu is nu geconfigureerd in de menu-manager.");
define("BNRLAN_PLACEHOLDER_OR_NEW_CLIENT", "Of voer nieuwe client in ");
define("BNRLAN_PLACEHOLDER_ENTER_CAMPAIGN", "Geef een capmpagne naam in ");
