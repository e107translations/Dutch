...
define("FORLAN_50", "Geef gebruikersklasse de mogelijkheid om een peiling te starten in de forums");
define("FORLAN_51", "Volgen van discussie mogelijk");
define("FORLAN_52", "Aankruisen als gebruikers met behulp van een e-mail gewaarschuwd worden als op de discussie wordt gereageerd");
define("FORLAN_53", "Email prefix");
define("FORLAN_54", "De te invoeren tekst zal als voorstuk dienen van de onderwerpregel op elke email gestuurd vanuit het forum");
define("FORLAN_55", "Populaire discussie drempelwaarde");
...
define("FORLAN_83", "Aanmaken Ouder(s)");
...
define("FORLAN_121", "Geen gemelde berichten");
define("FORLAN_122", "Klik hier om de beheerder te e-mailen wanneer iemand een ongewenste discussie meldt.");
...
define("FORLAN_131", "om de maximale bestandsomvang, toegestane types enz. in te stellen");
define("FORLAN_132", "Benadrukken Sticky discussies");
define("FORLAN_133", "Geef extra aandacht aan sticky discussies (scheiden van discussie secties en koppen)");
define("FORLAN_134", "Maximum breedte van geuploade afbeelding");
define("FORLAN_135", "Vul niets in om automatische verschaling niet te gebruiken");
define("FORLAN_136", "Creëer link naar afbeelding op ware grootte");
define("FORLAN_137", "Het activeren van deze functie verschaalt grote afbeeldingen en creëert een link naar de originele afbeelding op ware grootte. Als de functie niet is geactiveerd, wordt de originele afbeelding niet gebruikt");
...
define("FORLAN_160", "Kies ervoor om dit alleen voor forums uit te voeren, niet voor discussies");
define("FORLAN_161", "Herberekenen bericht/reactie telling");
define("FORLAN_162", "Selecteren om de forum discussies/reacties te herberekenen");
define("FORLAN_163", "Herberekenen forumbericht telling gebruiker");
define("FORLAN_164", "Selecteren om de forumbericht telling te herberekenen");
