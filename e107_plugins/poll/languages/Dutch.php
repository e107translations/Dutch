...
define("POLLAN_1",  "Aanwezige peilingen");
define("POLLAN_2",  "Opstellen / bewerken peilingen");
define("POLLAN_3",  "Peilingsvraag");
define("POLLAN_4",  "Opties");
define("POLLAN_8",  "Nieuwe optie toevoegen");
define("POLLAN_9",  "Multiple choice toegestaan?");
define("POLLAN_10", "ja");
define("POLLAN_11", "nee");
...
define("POLLAN_19", "Gebruikers ID (alleen leden kunnen stemmen)");
define("POLLAN_20", "Reageren op deze peiling toegestaan?");
define("POLLAN_21", "Bekijk nogmaals");
define("POLLAN_22", "Bijwerken peiling");
define("POLLAN_23", "Opstellen peiling");
...
define("POLLAN_34", "Titel");
define("POLLAN_35", "Geplaatst door");
define("POLLAN_36", "Actief");
define("POLLAN_37", "actief van");
define("POLLAN_38", "tot");
define("POLLAN_39", "Hartelijk dank voor het stemmen!");
define("POLLAN_40", "Klik hier voor de resultaten");
define("POLLAN_41", "Deze peiling is alleen voor leden");
...
define("POLLAN_POST_POLL", "Plaats peiling");
...
define("LAN_FORUM_3033", "Toestaan meerkeuze optie?"); 
define("LAN_FORUM_3034", "Stem opslagmethode"); 
