...
define("COMPLIANCE_L1", "W3C Naleving");
define("SITEBUTTON_MENU_L1", "Link naar ons");
define("POWEREDBY_L1", "Mogelijk gemaakt door");

define("COUNTER_L1", "Beheer bezoeken worden niet geteld.");
